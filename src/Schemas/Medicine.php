...
use Gii\ModuleMedicalItem\Resources\Medicine\{
    ShowMedicine, ViewMedicine 
};
...
class Medicine extends MedicalItem implements Contracts\Medicine {
    ...
    protected array $__add     = [
        'name','status','acronym', 'is_lasa', 'is_antibiotic', 'is_high_alert' , 'is_narcotic',
        'usage_location_id', 'usage_route_id', 'therapeutic_class_id', 'dosage_form_id',
        'package_category_id', 'selling_category_id'
    ];
